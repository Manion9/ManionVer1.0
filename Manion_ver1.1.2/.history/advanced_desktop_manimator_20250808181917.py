...
# .env 파일 자동 로딩 비활성화 - 사용자가 직접 입력하도록 함
...
"""
        ...
        ttk.Button(btn_frame, text="✅ 설정 완료", command=save_key, 
                   style='Accent.TButton').pack(side=tk.LEFT, padx=(0, 10))
        ttk.Button(btn_frame, text="🧪 연결 테스트", command=test_key).pack(side=tk.LEFT, padx=(0, 5))
        ttk.Button(btn_frame, text="❌ 취소", command=settings_window.destroy).pack(side=tk.RIGHT)
